		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('fa-solid fa-heart')
						]),
					_List_Nil),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/aloussase/elm-spreadsheet')
						]),
					_List_fromArray(
						[
							A2(
		...
		return A2(
			...
			A2(
				...
				$elm$core$String$toInt(
					A2($elm$core$String$dropLeft, 1, _var))),
			A2(
				$elm$core$Maybe$withDefault,
				'A',
				A2(
						...
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2(
									'cell-error',
									$elm_community$maybe_extra$Maybe$Extra$isNothing(cellResult))
								]))
						]),
					_List_Nil)
				]));
	...
	function (model, row, col) {
		if (!col) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('row-number')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
